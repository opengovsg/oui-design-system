...
export const WithUploadedFile: Story = {
  args: {
    value: [MOCK_OGP_LOGO_FILE, MOCK_OGP_ICON_FILE, MOCK_TEXT_FILE],
    allowedMimeTypes: ["image/*"],
    maxFiles: 5,
  },
  render: Template,
...
export const WithUploadedFileDisabled: Story = {
  args: {
    ...WithUploadedFile.args,
    isDisabled: true,
  },
}
export const WithUploadedFileReadonly: Story = {
  args: {
    ...WithUploadedFile.args,
    isReadOnly: true,
  },
  ...
  render: (args: FileDropzoneProps) => {
    return (
      <div className="flex flex-col space-y-8">
        ...
        <FileDropzone
          label="Medium"
          description="This is a Medium Description"
          {...args}
          size="md"
        />
      </div>

...
The FileDropzone automatically validates files against your constraints. Use the `onError` callback to handle validation errors and display them as a toast.

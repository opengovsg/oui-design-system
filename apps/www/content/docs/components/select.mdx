...
*Inherits all remaining props from React Aria's [Select](https://react-aria.adobe.com/Select). Notable ones: `autoFocus`, `name`, `form`, `autoComplete`, `allowsEmptyCollection`, `excludeFromTabOrder`.*

...
_Inherits all remaining props from React Aria's [SearchField](https://react-aria.adobe.com/SearchField). Notable ones: `autoFocus`, `excludeFromTabOrder`, `name`, `autoComplete`._

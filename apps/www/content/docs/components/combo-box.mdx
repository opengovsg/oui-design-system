...
_Inherits all remaining props from React Aria's [ComboBox](https://react-aria.adobe.com/ComboBox). Notable ones: `autoFocus`, `allowsCustomValue`, `menuTrigger`, `formValue`, `excludeFromTabOrder`._

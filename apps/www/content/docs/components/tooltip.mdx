...
Use **Tooltip** for short, non-blocking hints shown on hover or focus. Use [Modal](/docs/components/modal) when content requires interaction. Use the field's `description` prop for inline help text on form inputs.
